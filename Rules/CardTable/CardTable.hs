...
nameCard (Card (CodexCard NeutralColor Spell_1) _) = "Harmony"
nameCard (Card (CodexCard NeutralColor Spell_2) _) = "Discord"
nameCard (Card (CodexCard NeutralColor Spell_3) _) = "Inspire"
nameCard (Card (CodexCard NeutralColor Spell_Ult) _) = "Cacaphony"
nameCard (Card (CodexCard NeutralColor Tech_1_1) _) = "Iron Man"
nameCard (Card (CodexCard NeutralColor Tech_1_2) _) = "Revolver Ocelot"
nameCard (Card (CodexCard NeutralColor Tech_2_1) _) = "Hired Stomper"
nameCard (Card (CodexCard NeutralColor Tech_2_2) _) = "Regular Sized Rhinoceros"
nameCard (Card (CodexCard NeutralColor Tech_2_3) _) = "Sneaky Pig"
nameCard (Card (CodexCard NeutralColor Tech_2_4) _) = "Egg Ship"
nameCard (Card (CodexCard NeutralColor Tech_2_5) _) = "Harvest Reaper"
nameCard (Card (CodexCard NeutralColor Tech_3_1) _) = "Trojan Duck"
...
nameCard (Card (CodexCard Anarchy Tech_3_1) _) = "Pirate Gunship"
nameCard (Card (CodexCard Blood Tech_3_1) _) = "Pirate-Gang Commander"
nameCard (Card (CodexCard Fire Tech_3_1) _) = "Cinderblast Dragon"
...
nameCard (Card (CodexCard Balance Tech_3_1) _) = "Tyrannosaurus Rex"
nameCard (Card (CodexCard Feral Tech_3_1) _) = "Moss Ancient"
nameCard (Card (CodexCard Growth Tech_3_1) _) = "Guargum, Eternal Sentinel"
...
cardImage (CodexCard NeutralColor Spell_1) = SDImage "images/cards/_0020_harmony.jpg"
cardImage (CodexCard NeutralColor Spell_2) = SDImage "images/cards/_0021_discord.jpg"
cardImage (CodexCard NeutralColor Spell_3) = SDImage "images/cards/_0022_inspire.jpg"
cardImage (CodexCard NeutralColor Spell_Ult) = SDImage "images/cards/_0023_cacophony.jpg"
cardImage (CodexCard NeutralColor Tech_1_1) = SDImage "images/cards/_0012_iron%man.jpg"
cardImage (CodexCard NeutralColor Tech_1_2) = SDImage "images/cards/_0013_revolver%ocelot.jpg"
cardImage (CodexCard NeutralColor Tech_2_1) = SDImage "images/cards/_0014_hired stomper.jpg"
cardImage (CodexCard NeutralColor Tech_2_2) = SDImage "images/cards/_0015_regular-sized%rhinoceros.jpg"
cardImage (CodexCard NeutralColor Tech_2_3) = SDImage "images/cards/_0016_sneaky pig.jpg"
cardImage (CodexCard NeutralColor Tech_2_4) = SDImage "images/cards/_0017_eggship.jpg"
cardImage (CodexCard NeutralColor Tech_2_5) = SDImage "images/cards/_0018_harvest%reaper.jpg"
cardImage (CodexCard NeutralColor Tech_3_1) = SDImage "images/cards/_0019_trojan%duck.jpg"
...
cardImage (CodexCard Anarchy Spell_1) = SDImage "images/cards/_0011_chaos%mirror.jpg"
cardImage (CodexCard Anarchy Spell_2) = SDImage "images/cards/_0012_detonate.jpg"
cardImage (CodexCard Anarchy Spell_3) = SDImage "images/cards/_0013_surprise%attack.jpg"
cardImage (CodexCard Anarchy Spell_Ult) = SDImage "images/cards/_0014_maximum%anarchy.jpg"
...
cardImage (CodexCard Blood Spell_Ult) = SDImage "images/cards/_0018_war%drums.jpg"
cardImage (CodexCard Fire Spell_1) = SDImage "images/cards/_0019_fire%dart.jpg"
cardImage (CodexCard Fire Spell_2) = SDImage "images/cards/_0020_ember%sparks.jpg"
cardImage (CodexCard Fire Spell_3) = SDImage "images/cards/_0021_flame%arrow.jpg"
cardImage (CodexCard Fire Spell_Ult) = SDImage "images/cards/_0022_burning%volley.jpg"
cardImage (CodexCard Anarchy Tech_1_1) = SDImage "images/cards/_0023_calypso%gypsy.jpg"
cardImage (CodexCard Anarchy Tech_1_2) = SDImage "images/cards/_0024_gunpoint%taxman.jpg"
cardImage (CodexCard Blood Tech_1_1) = SDImage "images/cards/_0025_crash%bomber.jpg"
...
cardImage (CodexCard Anarchy Tech_2_1) = SDImage "images/cards/_0029_disguised%monkey.jpg"
cardImage (CodexCard Anarchy Tech_2_2) = SDImage "images/cards/_0030_chameleon&lizzo.jpg"
...
cardImage (CodexCard Anarchy Tech_3_1) = SDImage "images/cards/_0044_pirate%20gunship.jpg"
cardImage (CodexCard Blood Tech_3_1) = SDImage "images/cards/_0045_pirate-gang%20commander.jpg"
cardImage (CodexCard Fire Tech_3_1) = SDImage "images/cards/_0046_cinderblast%20dragon.jpg"
...
cardImage (CodexCard Balance Spell_1) = SDImage "images/cards/_0010_moments%peace.jpg"
cardImage (CodexCard Balance Spell_2) = SDImage "images/cards/_0011_nature%reclaims.jpg"
cardImage (CodexCard Balance Spell_3) = SDImage "images/cards/_0012_circle%of%life.jpg"
cardImage (CodexCard Balance Spell_Ult) = SDImage "images/cards/_0013_final%showdown.jpg"
cardImage (CodexCard Feral Spell_1) = SDImage "images/cards/_0014_ferocity.jpg"
cardImage (CodexCard Feral Spell_2) = SDImage "images/cards/_0015_behind%the%ferns.jpg"
cardImage (CodexCard Feral Spell_3) = SDImage "images/cards/_0016_murkwood%allies.jpg"
cardImage (CodexCard Feral Spell_Ult) = SDImage "images/cards/_0017_feral%strike.jpg"
cardImage (CodexCard Growth Spell_1) = SDImage "images/cards/_0018_polymorph%squirrel.jpg"
cardImage (CodexCard Growth Spell_2) = SDImage "images/cards/_0019_dinosize.jpg"
cardImage (CodexCard Growth Spell_3) = SDImage "images/cards/_0020_spirit%of%the panda.jpg"
cardImage (CodexCard Growth Spell_Ult) = SDImage "images/cards/_0021_stampede.jpg"
cardImage (CodexCard Balance Tech_1_1) = SDImage "images/cards/_0022_gemscout%owl.jpg"
cardImage (CodexCard Balance Tech_1_1) = SDImage "images/cards/_0023_tiny%basilisk.jpg"
...
cardImage (CodexCard Growth Tech_1_1) = SDImage "images/cards/_0026_galina%glimmer.jpg"
cardImage (CodexCard Growth Tech_1_2) = SDImage "images/cards/_0027_giant%panda.jpg"
cardImage (CodexCard Balance Tech_2_1) = SDImage "images/cards/_0028_chameleon.jpg"
cardImage (CodexCard Balance Tech_2_2) = SDImage "images/cards/_0029_fairie%dragon.jpg"
cardImage (CodexCard Balance Tech_2_3) = SDImage "images/cards/_0030_dothram%horselord.jpg"
cardImage (CodexCard Balance Tech_2_4) = SDImage "images/cards/_0031_wandering%mimic.jpg"
cardImage (CodexCard Balance Tech_2_5) = SDImage "images/cards/_0032_potent%basilisk.jpg"
...
cardImage (CodexCard Balance Tech_3_1) = SDImage "images/cards/_0043_tyrannosaurus%20rex.jpg"
cardImage (CodexCard Feral Tech_3_1) = SDImage "images/cards/_0044_moss%20ancient.jpg"
cardImage (CodexCard Growth Tech_3_1) = SDImage "images/cards/_0045_guargum.jpg"
