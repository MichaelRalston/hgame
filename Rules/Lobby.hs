...
playerRenderer _ _ = Map.fromList 
	[ (dataZone, (ET.ZDD {ET.display = ET.ZDHorizFill 5, ET.order=0, ET.classNames = []},[ET.SE 1 (ET.SDText "MAEK GAEM") (ET.SESAutoWidth 95) False False False True [] Nothing]))
	, (gamelogZone, (ET.ZDD {ET.display = ET.ZDHorizFill 90, ET.order=1, ET.classNames = []},[]))
	, (inputZone, (ET.ZDD {ET.display = ET.ZDHorizFill 5, ET.order=2, ET.classNames = []},[ET.SE 0 ET.SDTextInput (ET.SESPercent 100 100) False False False True [] Nothing]))
	]
